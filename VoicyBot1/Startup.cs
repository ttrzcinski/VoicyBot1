...
namespace VoicyBot1
{
    ...
    public class Startup
    {
        ...
        {
            services.AddBot<VoicyBot1Bot>(options =>
            {
            ...
            services.AddSingleton<VoicyBot1Accessors>(sp =>
            {
                // Create the custom state accessor.
                return new VoicyBot1Accessors(conversationState, userState)
                {
                    ConversationDataAccessor = conversationState.CreateProperty<ConversationData>(VoicyBot1Accessors.ConversationDataName),
                    UserProfileAccessor = userState.CreateProperty<UserProfile>(VoicyBot1Accessors.UserProfileName),
                };
            });
        }
